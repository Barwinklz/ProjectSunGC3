package geniussixtyfour.dev.mods.projectsun.Asteroids.Vulcanoids.worldgen.sky;
...
public class SkyProviderVulcanoids extends IRenderHandler
{
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        WorldProviderVulcanoids gcProvider = null;

        if (world.provider instanceof WorldProviderVulcanoids)
        {
            gcProvider = (WorldProviderVulcanoids) world.provider;
        }
        ...
        var12 = 795F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderVulcanoids.sunTexture);
        var23.startDrawingQuads();
